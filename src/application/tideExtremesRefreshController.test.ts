...
import { createTideExtremesRefreshController } from "./tideExtremesRefreshController";
...
describe("createTideExtremesRefreshController", () => {
  it("invokes onLoading then onSuccess with civil-day start from deps", async () => {
    ...
    refreshTideExtremesForTown(aTown);
  ...
  it("ignores stale completion when a newer refresh was started", async () => {
    ...
    refreshTideExtremesForTown(aTown);
    refreshTideExtremesForTown(otherTown);
