...
<main class="route software-nerd-route">
  ...
  <p class="software-nerd-route__lede">
  	An overview of how The Tide Dial is structured, coded and deployed from a software
	development point of view. For people interested in that kind of thing.
    It's open-source and you can see the code here:
    <a
  ...
  >
    ...
    <p class="software-nerd-route__p">
      ...
      — but not in one heroic paste. An experienced software developer directed the work
	  across over 600 small
