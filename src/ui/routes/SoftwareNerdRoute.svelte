...
<main class="route software-nerd-route">
  ...
  >
    ...
    <p class="software-nerd-route__p">
      ...
      — but not in one heroic paste. An experienced software developer directed the work in hundreds
      of small steps: scope, review, tests, naming, refactoring, housekeeping, and “no, not like that”
