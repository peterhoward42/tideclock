...
export const homeTideStyleModel: StyleModelSpec = {
  ...
  bindings: [
    ...
    { name: "HandArmTimeLabel", roleName: "role.now.live" },
    ...
    { name: "TimeNowLabelHms", roleName: "role.structure.text" },
    { name: "TimeNowLabelSecondsColon", roleName: "role.structure.text" },
    { name: "TimeNowLabelSeconds", roleName: "role.structure.emphasis" },
