...
export const homeTideStyleModel: StyleModelSpec = {
  ...
  bindings: [
    ...
    { name: "BossCircle", roleName: "role.structure.emphasis" },
    { name: "SmallCircle", roleName: "role.structure.emphasis" },
    { name: "Extension", roleName: "role.structure.emphasis" },
    { name: "Projection", roleName: "role.structure.emphasis" },
    { name: "Arm", roleName: "role.structure.emphasis" },
    { name: "PointerPipSideA", roleName: "role.structure.emphasis" },
    { name: "PointerPipSideB", roleName: "role.structure.emphasis" },
    { name: "PointerPipHeadArc", roleName: "role.structure.emphasis" },
