...
export const homeTideStyleModel: StyleModelSpec = {
  ...
  bindings: [
    ...
    { name: "BLHCLabelHms", roleName: "role.structure.text" },
    { name: "BLHCLabelSecondsColon", roleName: "role.structure.text" },
    { name: "BLHCLabelSeconds", roleName: "role.structure.emphasis" },
