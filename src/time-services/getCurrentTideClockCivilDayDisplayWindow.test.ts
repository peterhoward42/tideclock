...
import { getCurrentTideClockCivilDayDisplayWindow } from './getCurrentTideClockCivilDayDisplayWindow';
import type { TimeNowProvider } from './TideClockCivilDayDisplayWindow';
...
describe('getCurrentTideClockCivilDayDisplayWindow', () => {
  ...
  it('returns today midnight to tomorrow midnight for a morning time', () => {
    ...
    const result = getCurrentTideClockCivilDayDisplayWindow(nowProvider);
